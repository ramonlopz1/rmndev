    ...
    <header className={styles.header}>
      ...
      <nav className={styles.navigation}>
        ...
        {status === "authenticated" ? (
          <Link href="/panel" className={styles.panel_icon}>
            <TfiPanel style={{ fontSize: "23px" }} />
          </Link>
        ) : (
          false
        )}
        <ul className={styles.list}>
          <li className={styles.list_item}>
            <Link
              href="https://github.com/ramonlopz1"
              target="_blank"
              rel="My Github profile"
            >
              <FaGithubAlt />
            </Link>
          </li>
          <li className={styles.list_item}>
            <Link
              href="https://linkedin.com/in/ramonlopz1"
              target="_blank"
              rel="My LinkedIn profile"
            >
              <FaLinkedinIn />
            </Link>
          </li>
